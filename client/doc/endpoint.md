...
The name "EndpointClass" where Class is your class name will have the "Endpoint" part "../../frontier_client/doc"stripped when the client is code generated. When accessing you can simply use the endpoint name in lowercase.
