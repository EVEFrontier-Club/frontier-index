...
import '../schedullers/kilboard_scheduller.dart' as _i3;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'KilboardSchedullerLoadDataFutureCall':
          KilboardSchedullerLoadDataFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final kilboardScheduller = _KilboardSchedullerFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _KilboardSchedullerFutureCallDispatcher {
  _KilboardSchedullerFutureCallDispatcher(this._invokeFutureCall);
...
class KilboardSchedullerLoadDataFutureCall extends _i1.FutureCall {
  @override
  _i2.Future<void> invoke(
    _i1.Session session,
    _i1.SerializableModel? object,
  ) async {
    await _i3.KilboardScheduller().loadData(session);
  }
}
